(function ($) {
	...
	$.fn.countdown.begin = function (parent, settings) {
		...
		// DATE( year YYYY Format , month 1-12 , day 1-31 , 24 hour format 0-23, min 0-59, seconds 0-59)
		end = new Date(2022,1, 2, 0, 0, 0);
		//end = new Date(2021, settings.month - 1, settings.day, settings.hour, settings.minute, settings.second);
